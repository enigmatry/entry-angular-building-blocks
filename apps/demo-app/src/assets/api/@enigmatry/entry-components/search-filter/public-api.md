...
| <a id="value"></a> `value` | [`SelectOption`](#selectoption)\<`T`\> \| `undefined` | `undefined` | Default value to be displayed/selected in the input control | - | [`SearchFilterBase`](#searchfilterbase).[`value`](#value-3) |  |
...
| <a id="value-1"></a> `value` | `D` \| `undefined` | `undefined` | Default value to be displayed/selected in the input control | - | [`SearchFilterBase`](#searchfilterbase).[`value`](#value-3) |  |
...
| <a id="value-2"></a> `value` | `D` \| `undefined` | `undefined` | Default value to be displayed/selected in the input control | - | [`SearchFilterBase`](#searchfilterbase).[`value`](#value-3) |  |
...
| <a id="value-3"></a> `value` | `T` \| `undefined` | Default value to be displayed/selected in the input control |  |
...
| <a id="options-1"></a> `options$` | `Observable`\<[`SelectOption`](#selectoption)\<`T`\>[]\> \| `undefined` | `undefined` | Observable (dynamic) list of select filter options | - | - |  |
...
| <a id="value-4"></a> `value` | `T` \| `undefined` | `undefined` | Default value to be displayed/selected in the input control | - | [`SearchFilterBase`](#searchfilterbase).[`value`](#value-3) |  |
...
| <a id="value-5"></a> `value` | `string` \| `undefined` | `undefined` | Default value to be displayed/selected in the input control | - | [`SearchFilterBase`](#searchfilterbase).[`value`](#value-3) |  |
