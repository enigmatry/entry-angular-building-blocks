 ...
 */
export const provideEntryValidationConfig = (config: Partial<EntryValidationConfig>): Provider => provideConfig(ENTRY_VALIDATION_CONFIG, () => new EntryValidationConfig(config));
